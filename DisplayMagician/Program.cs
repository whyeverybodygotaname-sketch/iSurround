...
namespace DisplayMagician
{
    public static class Program
    {
        ...
        public static string AppWallpaperPath = Path.Combine(AppDataPath, "Wallpaper");
        ...
        private const string MutexName = "DisplayMagician_SingleInstance_Mutex";
        ...
        private static int Main(string[] args)
        {
            ...
            using (Mutex mutex = new Mutex(true, MutexName, out bool createdNew))
            {
                ...
                // 创建必要目录
                foreach (string dir in new[] { AppIconPath, AppProfilePath, AppWallpaperPath })
                {
        ...
        public static ApplyProfileResult ApplyProfileTask(ProfileItem profile)
        {
            ...
            {
                var update = new System.Windows.Forms.MethodInvoker(() => AppMainForm.UpdateNotifyIconText($"DisplayMagician ({profile.Name})"));
