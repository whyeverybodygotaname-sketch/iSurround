...
namespace iSurroundShared.Windows
{
    ...
    public struct DEVICE_MODE : IEquatable<DEVICE_MODE>
    {
        ...
        public bool Equals(DEVICE_MODE other)
            => //DeviceName.Equals(other.DeviceName) &&  // Removed specifically for iSurround matching. Remove if you need true equality matching
               //SpecificationVersion == other.SpecificationVersion &&
               //DriverVersion.Equals(other.DriverVersion) && // Removed specifically for iSurround matching. Remove if you need true equality matching
               //Size.Equals(other.Size) && // Removed specifically for iSurround matching. Remove if you need true equality matching
               //DriverExtra.Equals(other.DriverExtra) && // Removed specifically for iSurround matching. Remove if you need true equality matching
               //Fields.Equals(other.Fields) && // Removed specifically for iSurround matching. Remove if you need true equality matching
               //Position.Equals(other.Position) && // Removed specifically for iSurround matching. Remove if you need true equality matching
                DisplayOrientation.Equals(other.DisplayOrientation) &&
                //DisplayFixedOutput.Equals(other.DisplayFixedOutput) &&
                //Color.Equals(other.Color) && // Removed specifically for iSurround matching. Remove if you need true equality matching
                //Duplex.Equals(other.Duplex) && // Removed specifically for iSurround matching. Remove if you need true equality matching
                //YResolution.Equals(other.YResolution) && // Removed specifically for iSurround matching. Remove if you need true equality matching
                //TrueTypeOption.Equals(other.TrueTypeOption) && // Removed specifically for iSurround matching. Remove if you need true equality matching
                //Collate.Equals(other.Collate) && // Removed specifically for iSurround matching. Remove if you need true equality matching
                //FormName.Equals(other.FormName) && // Removed specifically for iSurround matching. Remove if you need true equality matching
                //LogicalInchPixels.Equals(other.LogicalInchPixels) && // Removed specifically for iSurround matching. Remove if you need true equality matching
        ...
        {
            // Removed specifically for iSurround matching. Remove if you need true equality matching
