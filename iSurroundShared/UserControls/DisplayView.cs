...
namespace iSurroundShared.UserControls
{
    public partial class DisplayView : UserControl
    {
        ...
        public DisplayView()
        {
            //InitializeComponent();启用设计模式检测，注释掉
            ResizeRedraw = true;
            if (LicenseManager.UsageMode == LicenseUsageMode.Designtime)
            {
                var dummyProfile = new ProfileItem();
                dummyProfile.Screens = new System.Collections.Generic.List<ScreenPosition>
                {
                    new ScreenPosition
                    {
                        ScreenX = 0,
                        ...
                        Library = "Windows",
                        IsPrimary = true,
                        Colour = Color.FromArgb(0, 174, 241),
                        TaskBarEdge = TaskBarLayout.TaskBarEdge.Bottom
                    }
                };
